...
export const TRAINERS = {
  ...
  // ---------- Gimnasio de las Mareas (Fase 14) ----------

  gym_trainer_tide_1: {
    id: "gym_trainer_tide_1",
    name: "Luma",
    role: "trainer",
    trainerClass: "explorer",
    gymId: "gym_tide",
    dialogueId: "gym_trainer_luma",
    dialogueDefeatedId: "gym_trainer_luma_done",
    team: [
      { speciesId: "marecal", level: 37 },
      { speciesId: "clarion", level: 38 },
    ],
    rewardMoney: 520,
    repeatable: false,
    anchorOffset: [-6, 5],
    anchorY: 0,
    colors: { skin: "#e8d0b8", outfit: "#2a7a88", accent: "#b8fff0" },
  },
  gym_trainer_tide_2: {
    id: "gym_trainer_tide_2",
    name: "Daro",
    role: "trainer",
    trainerClass: "ace",
    gymId: "gym_tide",
    dialogueId: "gym_trainer_daro",
    dialogueDefeatedId: "gym_trainer_daro_done",
    team: [
      { speciesId: "fosmar", level: 38 },
      { speciesId: "riazor", level: 39 },
      { speciesId: "arrecanto", level: 40 },
    ],
    rewardMoney: 600,
    repeatable: false,
    anchorOffset: [6, 5],
    anchorY: 0,
    colors: { skin: "#c9a888", outfit: "#1a4858", accent: "#ffb090" },
  },
  leader_talassa: {
    id: "leader_talassa",
    name: "Talassa",
    ...
    gymId: "gym_tide",
    leader: true,
    dialogueId: "gym_leader_talassa",
    dialogueDefeatedId: "gym_leader_talassa_done",
    dialogueCompletedId: "gym_leader_talassa_badge",
    team: [
      { speciesId: "fosmar", level: 40 },
      { speciesId: "cirrith", level: 41 },
      { speciesId: "arrecanto", level: 42 },
    ],
    rewardMoney: 1800,
    repeatable: false,
    anchorOffset: [0, 13],
    anchorY: 2,
    colors: { skin: "#e8d4c8", outfit: "#164858", accent: "#7ee8d8" },
  },
