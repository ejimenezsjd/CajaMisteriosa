...
export const CREATURE_ART = {
  ...
  riflin: {
    ...
    shadow: true,
    shadowRadius: 0.24,
    concept: "nudito de arrecife con caperuza de placas vivas",
    visual: { model: "riflin", shadowScale: 0.24, animationSet: "quadruped_small", effects: ["mist"] },
    portraitScale: 1.22, portraitYaw: 0.38, portraitPitch: -0.06, portraitOffsetY: -0.04,
  },
  marecal: {
    speciesId: "marecal",
    renderer: "stylized3d",
    ...
    shadow: true,
    shadowRadius: 0.42,
    concept: "anfibio costero de placas de arrecife",
    visual: { model: "marecal", shadowScale: 0.42, animationSet: "quadruped_athletic", effects: ["mist"] },
    portraitScale: 0.92, portraitYaw: 0.4, portraitPitch: -0.1, portraitOffsetY: -0.08,
  },
  arrecanto: {
    speciesId: "arrecanto",
    renderer: "stylized3d",
    ...
    shadow: true,
    shadowRadius: 0.68,
    concept: "guardián de arrecife con armadura de coral vivo",
    visual: { model: "arrecanto", shadowScale: 0.68, animationSet: "quadruped_mythic", effects: ["mist", "glow"] },
    portraitScale: 0.64, portraitYaw: 0.36, portraitPitch: -0.12, portraitOffsetY: -0.12,
    battleCameraDistance: 10.2,
    battleVisualOffset: 0.45,
  },
  fosmar: {
    speciesId: "fosmar",
    renderer: "stylized3d",
    ...
    shadow: true,
    shadowRadius: 0.3,
    concept: "wisp bioluminiscente de canales y ruinas",
